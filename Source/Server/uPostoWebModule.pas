...
var
  WebModuleClass: TComponentClass = TPostoWebModule;
...
uses uDsmbase, uPostoServerModule, Web.WebReq;

procedure TPostoWebModule.ServerFunctionInvokerHTMLTag(Sender: TObject; Tag: TTag;
  const TagString: string; TagParams: TStrings; var ReplaceText: string);
begin
...
procedure TPostoWebModule.WebModuleDefaultAction(Sender: TObject;
  Request: TWebRequest; Response: TWebResponse; var Handled: Boolean);
begin
...
procedure TPostoWebModule.WebModuleBeforeDispatch(Sender: TObject;
  Request: TWebRequest; Response: TWebResponse; var Handled: Boolean);
begin
...
function TPostoWebModule.AllowServerFunctionInvoker: Boolean;
begin
